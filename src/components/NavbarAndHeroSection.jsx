...
export default function NavbarAndHeroSection () {
    return(
            ...
            <div className="relative bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                        ...
                        {/*                <a href="#">*/}
                        {/*                    <span className="sr-only">CleveRange</span>*/}
                        ...
                        {/*            <a href="#" className="font-medium text-gray-500 hover:text-gray-900"><Link to="/">Home</Link></a>*/}

                        {/*            <a href="#" className="font-medium text-gray-500 hover:text-gray-900"><Link to="/lessonview">Project</Link></a>*/}

                        {/*            <a href="#" className="font-medium text-gray-500 hover:text-gray-900"><Link to="/about">About</Link></a>*/}

                        {/*            <a href="#" className="font-medium text-gray-500 hover:text-gray-900"><Link to="/contact">Contact</Link></a>*/}
                        ...
                        <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                            <div className="sm:text-center lg:text-left">
                                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                                    <span className="block xl:inline">Cleverange  </span>
                                    <span className="block text-indigo-600 xl:inline">Develop Your Skill</span>
                                </h1>
